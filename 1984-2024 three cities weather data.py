...
cities = [
    {"name": "Kyoto", "latitude": 35.0120, "longitude": 135.6761},
    {"name": "Liestal", "latitude": 47.4814, "longitude": 7.730519},
    {"name": "Washington", "latitude": 38.8853, "longitude": -77.0386},
]

# Define years and date range
start_month_day = "01-01"
end_month_day = "03-31"
years = list(range(1984, 2024))  # From 1984 to 2024
...
if historical_weather_data:
    ...
    historical_df.to_csv("5cities_historical_weather_1984_2024_2.csv", index=False)
